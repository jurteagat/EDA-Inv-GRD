...
- `midputs/rds/nombres_abreviados.csv` — curated short names keyed by `codigo_unico`; generated by `00_datos_entrada.qmd` from Google Sheets. Two columns: `codigo_unico` (character), `nom_inv_corto`.
